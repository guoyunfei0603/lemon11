...
if __name__ == '__main__':
    ...
    data2 = {'topicid':'MDAwMDAwMDAwMLSGpZmHubuv',
            'content':'测试发表评论~~',
            'anonymous':0}
    res2 = HttpRequest().http_request(url2,data2,"post",getattr(GetData,'Cookie'))
    print("发表评论的响应：",res2.json())
    ...
    res3 = HttpRequest().http_request(url3,data3,"post",getattr(GetData,'Cookie'))
    print("删除发表的评论响应：",res3.json())
